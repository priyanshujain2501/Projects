...
function Doctors() {
  ...
  // The useParams hook is a React Router hook used to access the URL parameters of the current route.It is commonly used when creating dynamic routes in a React application.

  // Key Points:
  // Returns an object containing the route parameters as key - value pairs.
  // The keys correspond to the parameter names defined in the route path.
  // The values are the actual parameter values from the URL.
  ...
  const applyFilter = () => {
      ...
      if(speciality){
        ...
        //if not speciality then show all doctors
    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-gray-600 ${showFilter ? "flex" : "hidden sm:flex"}`}>
          ...
          {/* If already we are on any speciality then after click it will show all doctors if not then show that particular speciality*/}
